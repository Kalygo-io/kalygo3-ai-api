"""
Knowledge-base (vector store) access grants router — aggregates grant sub-routers.
"""
...
from .list_shared import router as list_shared_router
...
router.include_router(list_shared_router)
